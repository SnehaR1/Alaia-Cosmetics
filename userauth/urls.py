...
urlpatterns = [
    ...
    path(
        "add_address/from_address/",
        add_address,
        {"from_address": True},
        name="add_address_from_address",
    ),
    path(
        "add_address/from_checkout/",
        add_address,
        {"from_checkout": True},
        name="add_address_from_checkout",
    ),
    path("razorpay_view/", razorpay_view, name="razorpay_view"),
]
if settings.DEBUG:
